...
function Quiz() {
  ...
  const ButtonAtt = () => {
    return (
      <Link to="/attestation">
        <button className="flex flex-col font-poppins bg-blue-500 text-white p-3 rounded hover:text-black transition ease-in delay-50">
  ...
  const ButtonRetry = () => {
    return (
      <Link to="/quizError">
        <button className="flex flex-col font-poppins bg-blue-500 text-white p-3 rounded">
          Réessayez
        </button>
      </Link>
    );
